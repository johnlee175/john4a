...
/**
 * A interface which will indicate how to define the log file name if writing to file perhaps.
 * <br>EXAMPLES:<br>
 * <code><pre>
 * public class DefaultLogFilePathFactory implements LogFilePathFactory {
 *    private final AtomicInteger mLastFileIndex = new AtomicInteger(0);
 ...
 * @version 2015-10-30
 * @see DefaultLogFilePathFactory
 */
public interface LogFilePathFactory {
