...
import com.johnsoft.library.util.Pool;
 ...
 */
public abstract class SQLiteHelper2
{
	private static final String TAG = SQLiteHelper2.class.getSimpleName();
...
//	private final Context mContext;
	...
	public SQLiteHelper2(Context context, String name, CursorFactory factory, int version)
	{
		...
		if (mRDatabases == null)
		{
			...
			try
			{
				...
				mRDatabases = new Pool<SQLiteDatabase>(4)
				{
					...
					{
						synchronized (SQLiteHelper2.this)
						{
							if (mIsInitializing)
							{
								throw new IllegalStateException("getDatabase called recursively");
